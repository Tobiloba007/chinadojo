    ...
    <div>
      ...
      <div className='hidden md:hidden lg:flex lg:flex-row lg:items-center lg:justify-between pt-10 xl:pt-12'>
         ...
         <div className='flex flex-row items-center justify-between'>
           <Link to='/'
           className='z-50 font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>HOME</Link>
           <Link to='/about'
           className='z-50 font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>ABOUT US</Link>
           <Link  to='/services'
           className='z-50 font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>SERVICES</Link>
           <Link  to={{ pathname: '/', search: '?sectionId=testimonials' }}
           className='z-50 font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>TESTIMONIALS</Link>
           <Link to={{ pathname: '/', search: '?sectionId=footer' }}
           className='z-50 flex items-center justify-center font-inter text-[11px] text-white bg-[#1A8F98] hover:bg-[#F8C605] hover:text-[#474545]
