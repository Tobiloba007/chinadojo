  ...
  const items = [
    {
      label: <div className='flex flex-col justify-center'>
        <Link className='font-inter text-[12px] text-center pt-7 pb-2 font-[500] hover:text-[#1A8F98]'>HOME</Link>
        <hr className='mx-10' />
              </div>, 
      key: '0',
    },
    {
      label: <div className='flex flex-col justify-center'>
        <Link className='font-inter text-[12px] text-center pt-5 pb-2 font-[500] hover:text-[#1A8F98]'>ABOUT US</Link>
        <hr className='mx-10' />
              </div>, 
      key: '1',
    },
    {
      label: <div className='flex flex-col justify-center'>
        <Link className='font-inter text-[12px] text-center pt-5 pb-2 font-[500] hover:text-[#1A8F98]'>SERVICES</Link>
        <hr className='mx-10' />
              </div>, 
      key: '2',
    },
    ...
    <div>
      ...
      <div className='hidden md:hidden lg:flex lg:flex-row lg:items-center lg:justify-between pt-10 xl:pt-12'>
         ...
         <div className='flex flex-row items-center justify-between'>
           <Link className='font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>HOME</Link>
           <Link className='font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>ABOUT US</Link>
           <Link className='font-inter text-[12px] text-white font-[600] mx-5 xl:text-[16px] hover:text-[#F8C605]'>SERVICES</Link>
